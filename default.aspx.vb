...
Partial Class _Default
    ...
    Protected Sub btnClear_Click(sender As Object, e As EventArgs) Handles btnClear.Click
        'clear texts and table values
        Me.tbAnnualInterest.Text = String.Empty
        Me.tbLoanAmt.Text = String.Empty
        Me.tbLoanTerm.Text = String.Empty
        Me.lblMonthlyPmt.Text = String.Empty
        'hidden the div id=new part
        Me.[new].Visible = False

        'clear the table and hid it as the same time
